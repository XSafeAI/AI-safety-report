...
# LLM Model Batch Evaluation Script (Multi-threaded version)
# Supports multiple models: Gemini, GPT, DeepSeek, DashScope, Ark, etc.

set -e

echo "=========================================="
echo "  LLM Model Batch Evaluation Script (Multi-threaded version)"
echo "=========================================="
echo ""
...
show_help() {
    ...
    echo "  --max-samples N            Maximum samples per dataset (default: 10000)"
    echo "  --concurrency N            Number of concurrent threads (default: 8)"
    echo "  --reasoning-effort LEVEL   Reasoning effort: low/medium/high (default: low)"
    echo "  --max-tokens N             Maximum tokens (default: 128)"
...
echo ""
echo "=========================================="
echo "Starting batch evaluation (multi-threaded mode)..."
echo "=========================================="
echo ""
...
for dataset in "${DATASETS[@]}"; do
    ...
    # Run evaluation (using multi-threaded version)
    if python3 /data/data-pool/dingyifan/GeminiEvaluation/evaluation/evaluate_thread.py \
        --dataset "$dataset" \
...
echo "Statistics:"
echo "  Model: $MODEL"
echo "  Execution mode: Multi-threaded (threads: $CONCURRENCY)"
